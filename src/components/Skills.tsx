...
const skills = [
  ...
  { name: 'Creative Problem Solving', level: 88, icon: Layout, color: 'hsl(var(--spring-primary))' },
  { name: 'Database Management', level: 80, icon: Database, color: 'hsl(var(--summer-primary))' },
];
      ...
      <div className="max-w-5xl mx-auto w-full">
        ...
        <div className="mt-16 bg-card/50 backdrop-blur-sm rounded-2xl p-8 shadow-xl border border-border/50">
          ...
          <div className="flex flex-wrap gap-3 justify-center">
            {['HTML/CSS', 'JavaScript', 'TypeScript', 'Tailwind CSS', 'Figma', 'Git', 'Responsive Design', 'Accessibility', 'Performance Optimization'].map((tech) => (
              <span 
                key={tech} 
